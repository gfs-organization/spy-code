...
public class SpyCodeBenchmarker {
    ...
    private static final String SHORT_STRING = "The sly grey fox ran fast.";
    ...
    public void benchmark_test() {
        ...
        target.solution(RandomStringUtil.replaceRandomString(SHORT_STRING));
        target.solution(RandomStringUtil.replaceRandomString(MEDIUM_STRING));
        target.solution(RandomStringUtil.replaceRandomString(LONG_STRING));
    }
